...
public class ReturnDTO {
	...
	public ReturnDTO(String return_idx, String oreder_idx, int user_idx, int pro_idx, Date return_date,
			Date return_start_date, Date return_end_date, String return_reason) {
		super();
		this.return_idx = return_idx;
		this.oreder_idx = oreder_idx;
	...
	public String getOreder_idx() {
		return oreder_idx;
	}

	public void setOreder_idx(String oreder_idx) {
		this.oreder_idx = oreder_idx;
	}
