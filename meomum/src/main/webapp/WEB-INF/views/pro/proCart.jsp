					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="selectArea">
									<th class="column-5"> 
									<label>전체선택<input type="checkbox" name="selectAll"></label>
									</th>
								</tr>
								...
								<tr class="table_row">
									...
									<td class="column-3">${list.pro_month }</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="cart_amount" value="${list.cart_amount}">
									...
									<td class="column-5">수량*개월 수</td>
									
									<td class="column-3"><img src="images/icon/icon-close2.png" alt="CLOSE"></td>
