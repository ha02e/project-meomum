...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 mb-4">
                    <img src="/meomum/images/meomum_logo(bold).png" class="logo img-fluid" alt="로고">
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 mx-auto">
                    ...
                    <p class="text-white d-flex">
                        ...
                        <a href="meomun@meomum.com" class="site-footer-link">
                            meomun@meomum.com
                        </a>
                    </p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        <p class="copyright-text mb-0">Copyright © 2023 <a href="#">meomum</a>
                        <br>Distribution:
    ...
    <script src="js/bootstrap.min.js"></script>z
